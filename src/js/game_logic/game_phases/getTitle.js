define(['game_logic/drawing'], function(Drawing) {
	var getTitle = function() {
		...
		// set arrow position and size based on other objects's properties
		var arrow_pos = this.press_start.x - 65;
		var new_arrow_width = start_arrow.width * 0.8;
		var new_arrow_height = start_arrow.height * 0.8;
